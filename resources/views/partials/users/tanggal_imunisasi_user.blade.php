<div class="container" data-aos="fade-up">
     ...
     <div class="row">
          <div class="pt-4 pt-lg-0 content">
               <p class="fst-italic">
                    Berikut adalah detail hasil imunisasi anak anda yang sudah ter-input pada sistem kami.
               </p>
               <div class="container">
                    <div class="row">
                              ...
                              <table>
                                   ...
                                   <tbody>
                                        <tr>
                                             ...
                                             <td class="text-center">
                                                  @foreach ($balita as $balita)
                                                       {{ $balita->tgl_vaksin_1 ?? 'Belum Vaksin' }}
                                                  @endforeach
                                             </td>
                                        ...
                                        <tr>
                                             <th>BCG</th>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_2 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_3 ?? 'Belum Vaksin' }}
                                             </td>
                                        ...
                                        <tr>
                                             <th>* Polio Tetes 1</th>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_4 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_5 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_6 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_7 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_8 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_9 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_10 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_11 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_12 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_13 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_14 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_15 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-danger text-white"></td>
                                        ...
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_16 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                             <td class="bg-danger text-white"></td>
                                        </tr>
                                        <tr>
                                             ...
                                             <td class="bg-dark text-white"></td>
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_17 ?? 'Belum Vaksin' }}
                                             </td>
                                        </tr>
                                   </tbody>
                              </table>
                              ...
                              <table>
                                   ...
                                   <tbody>
                                        <tr>
                                             ...
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_18 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                        </tr>
                                        <tr>
                                             ...
                                             <td class="text-center">
                                                  {{ $balita->tgl_vaksin_19 ?? 'Belum Vaksin' }}
                                             </td>
                                             <td class="bg-warning"></td>
                                        </tr>
                                   </tbody>
