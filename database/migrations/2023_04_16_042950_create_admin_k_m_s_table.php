...
return new class extends Migration
{
     ...
     public function up()
     {
          Schema::create('admin_kms', function (Blueprint $table) {
               ...
               $table->string('tgl_vaksin_20')->nullable();

               $table->string('vaksin_21')->nullable();
               $table->string('tgl_vaksin_21')->nullable();
               
               $table->string('vaksin_22')->nullable();
               $table->string('tgl_vaksin_22')->nullable();

               $table->string('vaksin_23')->nullable();
               $table->string('tgl_vaksin_23')->nullable();

               $table->string('vaksin_24')->nullable();
               $table->string('tgl_vaksin_24')->nullable();

               $table->string('vaksin_25')->nullable();
               $table->string('tgl_vaksin_25')->nullable();

               $table->string('vaksin_26')->nullable();
               $table->string('tgl_vaksin_26')->nullable();

               $table->string('vaksin_27')->nullable();
               $table->string('tgl_vaksin_27')->nullable();
          });
