               ...
               <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                         ...
                         <div class="row mt-4">
                              ...
                              {{-- ! BB_PB_LAKI --}}
                              <div class="col-lg-12 mt-4">
                                   <div id="chartKMS_bb_pb_laki_0_2" data-highcharts-chart="4"
                                        style="overflow: hidden;" aria-hidden="false">
                                   </div>
                              </div>
                              <div class="col-lg-12 mt-4">
                                   <div id="chartKMS_bb_pb_laki_2_5" data-highcharts-chart="5"
                                        style="overflow: hidden;" aria-hidden="false">
                                   </div>
                              </div>
                              ...
                              {{-- ! BB_PB_PR --}}
                              <div class="col-lg-12 mt-4">
                                   <div id="chartKMS_bb_pb_perempuan_0_2" data-highcharts-chart="6"
                                        style="overflow: hidden;" aria-hidden="false">
                                   </div>
                              </div>
                              <div class="col-lg-12 mt-4">
                                   <div id="chartKMS_bb_pb_perempuan_2_5" data-highcharts-chart="7"
                                        style="overflow: hidden;" aria-hidden="false">
                                   </div>
                              </div>
                         </div>
                              ...
                              if (data !== null) {
                                   ...
                                   $.ajax({
                                        ...
                                        success: function(detail) {
                                             ...
                                             {{-- ! KMS --}}
                                             // if (detail.umur_sekarang >=
                                             //      0 && detail
                                             //      .umur_sekarang <= 24) {

                                             //      console.log('umur 0-24');
                                             // } else if (detail
                                             //      .umur_sekarang > 24 &&
                                             //      detail.umur_sekarang <=
                                             //      60
                                             // ) {
                                             //      console.log(
                                             //           'umur 24-60');
